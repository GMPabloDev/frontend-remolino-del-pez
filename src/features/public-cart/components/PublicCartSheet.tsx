...
export function PublicCartSheet() {
	const { clearCart, items, persistenceWarning, totals } = usePublicCart();
				...
				<div className="flex min-h-0 flex-1 flex-col">
					{persistenceWarning ? (
						<Alert className="m-4 mb-0" variant="destructive">
							...
							<AlertDescription>
								Este carrito seguirá disponible durante esta sesión, pero no se
								conservará al cerrar la pestaña.
							</AlertDescription>
						</Alert>
					) : null}
					{hasUnverifiedItems ? (
						<Alert className="m-4 mb-0">
							...
							<AlertDescription>
								No pudimos confirmar estos platos. Se verificarán antes de crear
								la reserva.
							</AlertDescription>
						</Alert>
					) : null}
