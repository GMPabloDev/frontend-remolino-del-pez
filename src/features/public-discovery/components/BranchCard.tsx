	...
	return (
		<article className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-[#12324a]/10 bg-white/85 p-5 shadow-[0_18px_50px_rgba(18,50,74,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(18,50,74,0.14)] sm:p-6">
			<div className="flex items-start justify-between gap-4">
				...
				<span
					className="grid size-11 shrink-0 place-items-center rounded-2xl bg-[#dcecef] text-[#12324a]"
					aria-hidden="true"
				>
			...
			<div className="mt-6 space-y-3 text-sm leading-6 text-[#12324a]/70">
				...
				<p className="flex items-center gap-2.5">
					...
					/>
					<a
						className="underline decoration-[#e76832]/40 underline-offset-4 hover:text-[#e76832]"
				...
				{branch.email ? (
					<p className="flex items-center gap-2.5">
						...
						/>
						<a
							className="truncate underline decoration-[#e76832]/40 underline-offset-4 hover:text-[#e76832]"
			...
			<div className="mt-6 grid grid-cols-2 gap-2 border-y border-[#12324a]/10 py-4 text-xs text-[#12324a]/65">
				<p className="flex items-center gap-2">
					<Clock3
						className="shrink-0 text-[#338faa]"
						size={15}
						aria-hidden="true"
					/>
					<span>
						<strong className="font-semibold text-[#12324a]">
							{duration} min
						</strong>{" "}
						por reserva
					</span>
