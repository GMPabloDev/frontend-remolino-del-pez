		...
		dishes: [
			{
				...
				description:
					"Capas de papa amarilla, pollo crocante y crema de ají amarillo.",
				imageUrl:
			...
			},
			{
				...
				description:
					"Crujientes, dorados y servidos con salsa de rocoto dulce.",
				imageUrl: null,
		...
		dishes: [
			{
				...
				description:
					"Arroz cremoso con langostinos, chorizo artesanal y hierbas frescas.",
				imageUrl:
			...
			},
			{
				...
				description:
					"Filete de pesca del día con papas doradas y ensalada fresca.",
				imageUrl: null,
