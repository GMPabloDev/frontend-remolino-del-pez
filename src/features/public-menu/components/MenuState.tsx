...
const stateCopy = {
  ...
  empty: {
    ...
    description:
      'Vuelve pronto para descubrir las novedades de esta sucursal.',
  },
  error: {
...
export function DishImageFallback() {
  return (
    <span className="flex h-full flex-col items-center justify-center gap-2 bg-[#dcecef] text-xs font-semibold uppercase tracking-[0.16em] text-[#12324a]/55" aria-hidden="true">
